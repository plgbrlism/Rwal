...
mod tests {
    ...
    fn test_cache_key_is_deterministic() {
        ...
        let k1 = cache_key(p, "kmeans", false, None, 12345);
        let k2 = cache_key(p, "kmeans", false, None, 12345);
        assert_eq!(k1, k2);
    }
    ...
    fn test_cache_key_differs_by_backend() {
        let p = Path::new("/home/user/wall.jpg");
        let k1 = cache_key(p, "kmeans",     false, None, 100);
        let k2 = cache_key(p, "median_cut", false, None, 100);
        assert_ne!(k1, k2);
    }
    ...
    fn test_cache_key_differs_by_light_mode() {
        let p = Path::new("/home/user/wall.jpg");
        let k1 = cache_key(p, "kmeans", false, None, 100);
        let k2 = cache_key(p, "kmeans", true,  None, 100);
        assert_ne!(k1, k2);
    }
    ...
    fn test_cache_key_differs_by_saturation() {
        let p = Path::new("/home/user/wall.jpg");
        let k1 = cache_key(p, "kmeans", false, None,       100);
        let k2 = cache_key(p, "kmeans", false, Some(0.5),  100);
        assert_ne!(k1, k2);
    }
    ...
    fn test_cache_key_differs_by_file_size() {
        let p = Path::new("/home/user/wall.jpg");
        let k1 = cache_key(p, "kmeans", false, None, 100);
        let k2 = cache_key(p, "kmeans", false, None, 999);
        assert_ne!(k1, k2);
    }

    #[test]
    fn test_cache_key_differs_by_path() {
        let k1 = cache_key(Path::new("/a.jpg"), "kmeans", false, None, 100);
        let k2 = cache_key(Path::new("/b.jpg"), "kmeans", false, None, 100);
        assert_ne!(k1, k2);
    }

    #[test]
    fn test_cache_key_is_hex_string() {
        let key = cache_key(Path::new("/wall.jpg"), "kmeans", false, None, 0);
